		...
		<td class="container" width="600" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto;" valign="top">
			<div class="content" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; max-width: 600px; display: block; margin: 0 auto; padding: 20px;">
				<table class="main" width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; border-radius: 3px; background-color: #fff; margin: 0; border: 1px solid #e9e9e9;" bgcolor="#fff"><tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td class="content-wrap aligncenter" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; text-align: center; margin: 0; padding: 20px;" align="center" valign="top">
                    ...
                    <p style="text-align: left;">Kami mohon maaf pesanan Anda tidak bisa terpenuhi karena tidak ada respon dari Seller dalam 1 x24 jam, dana yang telah Anda bayarkan kepada kami akan dikembalikan (refund).
                      <br><br>berikut informasi pemesanan anda :
                      <br><b>Invoice : #<?php echo $invoice;?></b>
                      <br><b>Total Bayar : <?php echo $total;?></b>
                      <br><b><?php echo $time;?></b>
                      <br><br>Untuk pengembalian dana akan kami lakukan dengan cara transfer bank. Anda cukup membalas email ini dengan melengkapi rekening tujuan pengembalian dana seperti berikut ini:
                      <br>- Nama Bank: 
                      <br>- No Rekening Bank:
                      <br>- Nama Pemilik Rekening:
                      <br><br>Proses pengembalian dana secara transfer ini memakan waktu 1 hari kerja.
                      <br><br>&mdash; Multi E-commerce
                    </p>
									</td>
								</tr></table></td>
